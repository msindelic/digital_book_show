      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10'>
        <div className='flex flex-col md:flex-row items-center justify-between gap-6'>
          <div className='text-center md:text-left'>
            <p className='font-display font-bold text-ink-800 text-lg'>
              Digital Book Show
            </p>
          ...
          <div className='flex flex-col items-center'>
            <p className='font-display font-bold text-ink-800 text-lg flex'>
            ...
            <nav className='flex items-center gap-6'>
              {[
                ...
                {
                  to: 'https://www.linkedin.com/in/msindelic84',
                  label: 'Linkedin',
                },
          ...
          <p className='text-xs text-ink-300 font-mono'>
            © {new Date().getFullYear()} created by Mihailo Sindelic. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
